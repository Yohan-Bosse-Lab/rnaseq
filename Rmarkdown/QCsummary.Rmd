...
#What is the effect of only using a fraction of the sequences (200k, 2M, 20M and all(96M) sequences)?
```{r effect of varried library size}
k200 = read.csv('lordmini_alignments/library_size/expression_df_200k.csv')
M2 = read.csv('lordmini_alignments/library_size/expression_df_2M.csv')
M20 = read.csv('lordmini_alignments/library_size/expression_df_20M.csv')
M96 = read.csv('lordmini_alignments/library_size/expression_df_96M.csv')

cor(k200[5:62707,3],M96[5:62707,3]);cor(k200[M96[,3]<1000,3],M96[M96[,3]<1000,3])
cor(M2[5:62707,3],M96[5:62707,3]);cor(M2[M96[,3]<1000,3],M96[M96[,3]<1000,3])
cor(M20[5:62707,3],M96[5:62707,3]);cor(M20[M96[,3]<1000,3],M96[M96[,3]<1000,3])
```
...
```{r correls}
txi = readRDS('lord_kallisto/part1/txi.rds')
txi_notrim = readRDS('lord_kallisto/part1_notrim/txi.rds')
